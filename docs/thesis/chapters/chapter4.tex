...
\textit{pycrdt-websocket}\footnote{\url{https://github.com/y-crdt/pycrdt-websocket}},
...
algorithm\footnote{\url{https://lz4.org/}} to the retrieved data. The output of the
...
\textit{Quart}\footnote{\url{https://quart.palletsprojects.com/en/latest/#}} framework.
...
\textit{Hypercorn}\footnote{\url{https://hypercorn.readthedocs.io/en/latest/}} library,
which is used to deploy a standalone web server based on the
ASGI\footnote{\url{https://github.com/django/asgiref/blob/main/specs/asgi.rst}}
...
was built using the open-source \textit{uv}\footnote{\url{https://docs.astral.sh/uv/}}
...
\textit{Docker}\footnote{\url{https://www.docker.com/}} create lightweight, standalone
...
the \textit{Flet} framework\footnote{\url{https://flet.dev/}}, which offers a simple
...
UI software development kit \textit{Flutter}\footnote{\url{https://flutter.dev/}}.
